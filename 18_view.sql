...
INSERT INTO tbl_menu VALUES (NULL, '식혜맛국밥', 5000, 5, 'Y');
UPDATE tbl_menu SET category_code = 4 WHERE menu_name = '식혜맛국밥';

SELECT * FROM hansic;

INSERT INTO hansic VALUES (99, '수정과맛국밥', 5000, 4, 'Y');
...
-- 사용된 subQuery에 따라 DMB 명렁어로 조작이 불가능한 경우
...
-- view에 쓰인 subQuery안에 연산 결과 컬럼도 사용 가능하다.
CREATE VIEW hansic AS
SELECT
	menu_name AS "메뉴명" ,
